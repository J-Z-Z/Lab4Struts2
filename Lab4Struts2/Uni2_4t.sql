...
CREATE TABLE `curs` (
  ...
  `profesor_p_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`c_id`),
  KEY `u_id` (`u_id`),
  KEY `p_id` (`p_id`),
  KEY `FK2EC633CA404C5C` (`profesor_p_id`),
  ...
  CONSTRAINT `FK2EC633CA404C5C` FOREIGN KEY (`profesor_p_id`) REFERENCES `profesor` (`p_id`)
...
INSERT INTO `curs` VALUES (1,'Programarea in C++',1,1,NULL),(2,'Mecanica',1,2,NULL),(3,'Fizica',1,5,NULL),(4,'Economia Moldovei',2,3,NULL),(5,'Limba Franceza',2,4,NULL),(6,'Contabilitate',2,3,NULL),(7,'Dreptul',3,6,NULL),(8,'Psihologia',3,7,NULL),(9,'Etica',3,6,NULL);
...
INSERT INTO `profesor` VALUES (1,'Besliu','Victor','Stefan cel Mare, 30'),(2,'Gutuleac','Emilian','str.Studentilor,3'),(3,'Tucan',' Gabriela','str. Florilor, 24'),(4,'Birzu','Danie','str. Gh. Asachi,14'),(5,'Muresanu','Muresan','str. Mihai Viteazu,19'),(6,'Rednic','Simion','str. Hincesti, 198'),(7,'Alexandru','Stepanenco','str. Cosmonautilor, 30 apt. 8'),(8,'Chiorsac','Mircea','str. Mihai Eminescu, 23'),(9,'Sidelnicov','Vasile','str. Petru Zadnipru, 11'),(10,'Diligul','Alexandru','str. Banulescu Bodoni, 19'),(11,'Nichitin','Veaceslav','str. Sciusev, 131');
...
INSERT INTO `student` VALUES (1,'Victor','Dovgaliuc','TI-103','victor@gmail.com','068352011'),(2,'Andrian','Corneliu','TI-103','agiucorneliu@yhaoo.com','23-14-25'),(3,'Alexandru','Elena','TI-103','elena18@mail.ro','23-14-25'),(4,'Alexe','Alexandru','TI-103','alexalex@gmail.com','28-33-73'),(5,'Ardeleanu','Bogdan','TI-103','ardeleanudan@yahoo.com','24-44-09'),(6,'Atitienei','George','ME-059','georgeatit@yahoo.com','24-34-27'),(7,'Bacioiu','Vicentiu','ME-059','bacioivicentiu','71-34-75'),(8,'Badea','Cristina','ME-059','cristinea@mail.ro','35-10-20'),(9,'Badescu','Maria','ME-059','badescum@yahoo.com','43-64-65'),(10,'Bajanica','Ion','ME-059','ionbajanica@yahoo.com','35-12-27'),(11,'Balcan','Adrian','FAF-108','balcanadn@yahoo.com','37-11-35'),(12,'Baluta','Adrian','FAF-108','balutar@yahoo.ro','72-14-92'),(13,'Bazar','Cristina','FAF-108','cristinuta@yhaoo.com','63-94-55'),(14,'Bazavan','Alexandru','FAF-108','AlexandruBaz@gmail.com','53-40-47'),(15,'Bejenaru','Andreea','FAF-107','andreea@gmail.com','33-64-35'),(16,'Bobei','Alexandru','FAF-107','alexbob@mail.ro','93-64-19'),(17,'Bosoaga','Andreea','FAF-107','bosogaa@yahoo.com','23-14-25'),(18,'Bouros','Oana','FAF-107','oanabouros@mail.ro','22-54-45'),(19,'Brailescu','Petrut','REI-027','brailescu@yahoo.com','52-24-25'),(20,'Bubulan','Cosmin','REI-027','cosminbraiu@yahoo.com','43-14-25'),(21,'Buca','Elen','REI-027','eleonoruca@yahoo.com','23-16-25'),(22,'Bucurica','Cosmin','REI-027','cosmincoza@yahoo.com','22-14-25'),(23,'Buica','Elena','REI-027','buicael@yahoo.com','23-14-35'),(25,'Victor','Dovgaliuc','TI-101','djamanazar@gmail.com','285213'),(26,'Buliga','Andrei','TI-101','buligaandrei@gmail.com','41-21-64'),(27,'Crepcia','Mihai','TI-101','crepciamihai@gmail.com','42-36-24'),(28,'Ivanescu','Minu','TI-101','ivanescuminu@gmail.com','32-36-24'),(29,'Moldovan','Vasile','TI-102','moldovanvasile@gmail.com','94-28-55');
...
INSERT INTO `universitate` VALUES (1,'UTM','bd. Stefan cel Mare, 168','(+37322) 237-861'),(2,'ASE','str. Banulescu-Bodoni, 61','(+37322) 224-128'),(3,'USM','Str. Alexei Mateevici, 60','(+37322) 577-629'),(4,'ASSE','str. Mircea cel Batrin, 9','(+37322) 237-378');
...
-- Dump completed on 2013-02-06 11:16:14
